...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(url('css/tstyle.css')); ?>">
...
<body>
    ...
    <div class="br-sideleft overflow-y-auto">
        ...
        <div class="br-sideleft-menu">
            ...
            <li class="nav-item"><a href="<?php echo e(url('edit_profile_page')); ?>" class="nav-link">View/Edit Profile</a></li>
            ...
            <ul class="br-menu-sub nav flex-column">
                ...
                <li class="nav-item"><a href="<?php echo e(url('top_question_page')); ?>" class="nav-link">Search Question</a></li>
                <li class="nav-item"><a href="<?php echo e(url('post_question_page')); ?>" class="nav-link">Post Question</a></li>
                <li class="nav-item"><a href="<?php echo e(url('my_question_page')); ?>" class="nav-link">My Forum</a></li>
...
<?php /* C:\Users\Thashi Mudalige\Desktop\ITPM (WE_19_21)\SriCourses\resources\views/layouts/stu.blade.php */ ?>