...
<body>
  ...
  <a class="navbar-brand" href="<?php echo e(url('http://127.0.0.1:8000/')); ?>">ABC</a>
  ...
  <div class="collapse navbar-collapse" id="navbarsExampleDefault">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" href="<?php echo e(url('http://127.0.0.1:8000/')); ?>">Home <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
      ...
      <li class="nav-item dropdown">
        ...
        <a class="nav-link" href="#" tabindex="-1">About Us</a>
			...
			<?php if(auth()->guard()->guest()): ?>
				<a href="<?php echo e(url('login_page')); ?>" class="btn btn-info">Login </a> <?php else: ?>
				...
				<div class="login-tray">
					<ul class="log-list col-xs-12  pad-top-15">
						<li class=" col-xs-12">
							<a href="<?php echo e(url('/home')); ?>" class="links col-xs-12"><i class="fa fa-user" aria-hidden="true"></i>&nbsp;&nbsp;Profile</a>
						</li>
						<li class=" col-xs-12">
...
<?php /* C:\Users\Thashi Mudalige\Desktop\ITPM (WE_19_21)\SriCourses\resources\views/layouts/front.blade.php */ ?>