	...
	<div class="display-table full-width full-height mask">
		...
		<div class="table-cell v-align-b full-width ">
			<div class="container">
				...
				<p class="breadcrum pad-15"><a href="{{url('')}}" class="text-white">Home</a> <span class="text-theme-color-1">/</span> <span class="text-theme-color-1">Login Now</a></p>
			</div>
		</div>
	</div>
</div>
...
<section class="col-sm-12 col-xs-12 log-wrapper-1">
	<div class="container push-top-100 push-bot-100	">
		...
		<div class="col-md-6 col-sm-12 col-xs-12 login">
			...
			<form method="POST" action="{{url('login')}}" aria-label="{{__('Login')}}" class="col-sm-12 col-xs-12 main-login-form  pad-top-60  pad-bot-60 ">
				@csrf
				...
				<button type="submit" class="btn btn-default black center-block push-top-15">Sign In</button> {{-- <a class="btn btn-link"
