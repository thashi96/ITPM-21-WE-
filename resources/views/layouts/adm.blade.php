...
<ul class="br-menu-sub nav flex-column">
    ...
    <li class="nav-item"><a href="{{ url('create_courses_page') }}" class="nav-link">Add New Courses</a></li>
</ul>
...
<ul class="br-menu-sub nav flex-column">
    ...
    <li class="nav-item"><a href="{{ url('view_profiles_page') }}" class="nav-link">User Profils(EDIT/DELETE)</a></li>
    <li class="nav-item"><a href="{{ url('student_create') }}" class="nav-link">Add New Student</a></li>
</ul>
