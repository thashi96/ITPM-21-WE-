...
<div class="row">
    ...
    <form action="<?php echo e(url('search_question/')); ?>" method="post" enctype="multipart/form-data">
      ...
      <?php endif; ?>
      <br/>
      <?php $__currentLoopData = $qmy_details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /* C:\Users\Thashi Mudalige\Desktop\ITPM (WE_19_21)\SriCourses\resources\views/students/my_question.blade.php */ ?>